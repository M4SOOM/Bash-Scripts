# 🚀 Bash-Scripts – Cloud Automation Toolkit
...
- No state files
- CLI-first and transparent execution
- Easy to modify and extend
- Ideal for labs, PoCs, and learning cloud internals
- Works well alongside Terraform / Bicep (not a replacement)

## ⚙️ Prerequisites

Before running any script, ensure the following:
- Bash shell (Linux / macOS / WSL)
- Cloud CLI installed (AWS CLI / Azure CLI / gcloud)
